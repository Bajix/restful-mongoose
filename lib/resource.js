...
Resource.prototype.transform = function( data ) {
  var options = util._extend({
    transform: function( doc, ret, options ) {
      this.emit('transform', doc, ret, options)
    }
  }, this.options.toObject);
...
Resource.prototype.index = function( serializer ) {
  ...
  return function( req, res, next ) {
    ...
    async.waterfall([
      ...
      function( context, cb ) {
        var data = self.transform(context.models);
...
Resource.prototype.show = function( serializer ) {
  ...
  return function( req, res, next ) {
    ...
    async.waterfall([
      ...
      function( context, cb ) {
        var data = self.transform(context.model);
