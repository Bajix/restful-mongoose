...
Resource.prototype.transform = function( data, req ) {
  var options = util._extend({
    transform: function( doc, ret, options ) {
      this.emit('transform', doc, ret, options, req);
    }
  }, this.options.toObject);

  options.transform = options.transform.bind(this);

  if (data instanceof Array) {
    return data.map(function( data ) {
      if (data && typeof data.toObject === 'function') {
        return data.toObject(options);
      }
...
Resource.prototype.index = function( serializer ) {
  ...
  return function( req, res, next ) {
    var done = serializer.call(self, req, res, next);

    self.emit('sanitize', req);
    ...
    async.waterfall([
      ...
      function( context, cb ) {
        var data = self.transform(context.models, req);
...
Resource.prototype.create = function( serializer ) {
  ...
  return function( req, res, next ) {
    ...
    async.waterfall([
      ...
      function( model, numAffected, cb ) {
        var data = self.transform(model, req);
...
Resource.prototype.show = function( serializer ) {
  ...
  return function( req, res, next ) {
    ...
    async.waterfall([
      ...
      function( context, cb ) {
        var data = self.transform(context.model, req);
